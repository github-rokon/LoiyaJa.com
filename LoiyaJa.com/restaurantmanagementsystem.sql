...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 24, 2024 at 07:21 PM
...
CREATE TABLE `orderinfo` (
  ...
  `takeAwayDate` varchar(80) NOT NULL,
...
INSERT INTO `orderinfo` (`OrderID`, `CustomerName`, `Bill`, `takeAwayDate`, `OrderDate`, `OrderStatus`) VALUES
(1, '', 100, '', '', ''),
(2, '', 10, '', '', '');
...
(1, 'Prachurjo', '01402246680', 'prachurjo@gmail.com', 'Basundhara', '19/01/2002', 'Hindu', 'munna', '11111111', 'Uploads/Images/default_pfp.png', 'Customer', 'Active'),
(2, 'Rokon', '01402246680', 'admin@gmail.com', 'Mohammadpur', '2023-10-17', 'Islam', 'Mr_admin', '12345678', 'Uploads/Images/default_pfp.png', 'Admin', 'Active'),
