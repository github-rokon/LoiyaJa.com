    ...
    <table width="23%" border="1" cellspacing="0" cellpadding="25" align="center">
        <tr>
            <td align=center>
                ...
                <br><br>
                <a class="x"href="customer-review.php"><button name="x">Customer Reveiw</button></a>
                <br><br>
                <a class="x"href="update-stock.php"><button name="x">Update Stock</button></a>
                <br><br>
                <a class="x"href="update-stock-page.php"><button name="x">Update Stock Page</button></a>
                <br><br>
